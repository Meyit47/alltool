...
os.system("cd && bash alltool/.desing/desingpanel/desingpanel1.sh")
...
if(op==1):
 ...
 os.system("cd && cd alltool && python2 Files/TermuxS1.py")
elif(op==3):
 ...
 time.sleep(0.5)
 print("\033[1;31;40mTermux günlükleri temizlendi...")
 time.sleep(0.6)
 os.system("cd && cd alltool && python2 Files/TermuxS1.py")
elif(op==8):
 ...
 os.system("cd && cd alltool && python src/CheckPackages.py && python2 Files/TermuxS1.py ")
elif(op==13):
 os.system("cd && cd alltool && cp -r Termux-os /data/data/com.termux/files/home && cd && cd Termux-os && bash TermuxNewKeys.sh && cd && cd alltool && python2 Files/TermuxS1.py")
elif(op==14):
 time.sleep(0.2)
 ...
 print("\033[1;31;40mGeçersiz Giriş.Araçları Yeniden Yüklenmeli.") 
 time.sleep(1.6)
 os.system("cd")
 os.system("cd alltool")
