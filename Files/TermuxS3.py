...
os.system("cd && bash alltool/.desing/desingpanel/desingpanel3.sh")
...
if(op==1):
 ...
 os.system("cd && cd alltool && python2 Files/TermuxS2.py")
elif(op==3):
 ...
 os.system("cd && cd alltool && python2 Files/TermuxS3.py")
elif(op==5):
 os.system("cd")
 os.system("cd alltool)
 ...
 os.system("cd && cd alltool && python src/CheckPackages.py && python2 Files/TermuxS3.py ")
elif(op==13):
 os.system("cd && cd alltool && cp -r Termux-os /data/data/com.termux/files/home && cd && cd Termux-os && bash TermuxNewKeys.sh && cd && cd alltool && python2 Files/TermuxS3.py")
elif(op==14):
 time.sleep(0.2)
