...
cd ~/alltool/Termux-os/.object ; cp -r .colors.properties2 ~/.termux/colors.properties
cd ~/alltool/Termux-os/.object ; cp -r .termux.properties2 ~/.termux/termux.properties
